...
export default function ReviewCard({ name, review, image, rating = 5, reviewHeadings }: ReviewCardProps) {
  return (
    <div className="bg-[#f5f5f5] rounded-xl px-5 py-10 text-center max-w-sm mx-auto flex flex-col justify-between h-full border border-[#00823A]">
      ...
      {/* Review Title */}
      <h3 className="text-lg font-semibold text-[#5587A7] mb-4">{reviewHeadings}</h3>

      {/* Review Text with better responsive sizing */}
      <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6 flex-grow line-clamp-4">{review}</p>
