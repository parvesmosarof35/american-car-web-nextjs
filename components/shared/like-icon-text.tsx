interface LikeIconAndTextProps {
  imgSrc: string
  text: string
}

export default function LikeIconAndText({ imgSrc, text }: LikeIconAndTextProps) {
  return (
    <div className="flex flex-col items-center text-gray-900 mt-10">
      <div className="flex items-center justify-center w-16 h-16 mb-3">
        <img src={imgSrc || "/placeholder.svg"} alt={text} className="size-20 object-contain" />
      </div>
