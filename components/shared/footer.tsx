    ...
    <footer className="bg-[#3C3D37] text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
          <h2 className="text-2xl md:text-3xl font-bold">The marketplace for private registrations.</h2>
        ...
        <div className="text-center">
          <p className="text-yellow-500 text-sm">© 2025 Plate Exchange. Company number: 0245645</p>
        </div>
      </div>
    </footer>
  )
