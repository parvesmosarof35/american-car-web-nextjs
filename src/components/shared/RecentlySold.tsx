...
import { useGetSoldPlatesQuery } from "@/lib/api/PlatesApis/soldPlatesApi";
import LikeIconAndText from "./like-icon-text";
import img1 from "../../../public/1.png";
import img2 from "../../../public/2.svg";
import img3 from "../../../public/3.svg";

export default function RecentlySold() {
  const formatPlate = (reg: any) => {
    if (!reg) return "";
    const alnum = String(reg)
      .replace(/[^A-Za-z0-9]/g, "")
      .slice(0, 7);
    ...
    <div className="container mx-auto px-5 md:px-0 py-10 md:py-16 ">
      ...
      <div className="min-h-[20rem]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {data?.data?.all_sold_plates?.map((item: any, index: any) => (
            <div
              key={item._id || index}
      ...
      {/* Load All */}
      <div
        onClick={() => navigate.push("/all-plates")}
