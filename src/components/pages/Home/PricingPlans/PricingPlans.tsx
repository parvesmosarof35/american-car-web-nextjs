...
import { useCreateCheckoutMutation } from "@/lib/api/PaymentApis/createCheckoutApi";
import { useGetAllSubscriptionQuery } from "@/lib/api/subscriptionApi";
...
export default function PricingPlans() {
  ...
  const handleStartAdvert = async (subscriptionId : any) => {
    try {
      ...
      if (
        ...
        navigate.push("/userdashboard/secure-payments");
      }
    } catch (error) {
          ...
          <div key={subscription._id} className="flex justify-center mb-5">
            <div className="w-full max-w-[32rem] border-2 border-[#00823A] rounded">
              ...
              <div className="space-y-2 px-6 py-5">
                {subscription.featuresList?.map((feature : any) => (
